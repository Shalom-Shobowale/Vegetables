...
export default function AboutSection(){
    return(
        <div className="md:w-[90%] mx-auto flex flex-col md:flex-row gap-10 items-center">
            <div className="bg-no-repeat bg-cover bg-center h-[45vh] md:h-[90vh] w-full md:w-[45%]" style={{backgroundImage: "url(about1.jpg)"}}></div>
